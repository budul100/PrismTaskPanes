...
SET ExampleDirectory=..\Examples\DryIoc

"%windir%\Microsoft.NET\Framework\v4.0.30319\RegAsm.exe" /unregister ..\Base\PrismTaskPanes.Controls\bin\Debug\net472\PrismTaskPanes.Controls.dll
