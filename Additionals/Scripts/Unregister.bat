...
"%windir%\Microsoft.NET\Framework\v4.0.30319\RegAsm.exe" /unregister "%~dp0..\..\Base\PrismTaskPanes.Host\bin\Debug\net472\PrismTaskPanes.Host.dll"
...
"%windir%\Microsoft.NET\Framework\v4.0.30319\RegAsm.exe" /codebase "%CommonProgramFiles(x86)%\PrismTaskPanes.Host\PrismTaskPanes.Host.dll"
