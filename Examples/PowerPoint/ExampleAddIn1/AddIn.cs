...
{
    [COMAddin("PrismTaskPanes.PowerPointExampleAddIn1", "This is an ExampleAddIn1 description.", LoadBehavior.LoadAtStartup),
        ProgId("PowerPointExampleAddIn1.AddIn"),
        Guid("46DA6445-5BFC-489B-AF94-1DBCCFE6EC02"),
        ComVisible(true),
        Codebase]
        ...
        : COMAddin, ITaskPanesReceiver
    {
        ...
        {
            Application.PresentationBeforeCloseEvent += OnBeforeClose;
        ...
        private void OnBeforeClose(Presentation pres, ref bool cancel)
        {
