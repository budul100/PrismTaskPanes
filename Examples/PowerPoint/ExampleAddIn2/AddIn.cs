...
{
    [COMAddin("PrismTaskPanes.PowerPointExampleAddIn2", "This is an example addin", LoadBehavior.LoadAtStartup),
        ProgId("PowerPointExampleAddIn2.AddIn"),
        Guid("625A7E4E-113F-4A34-ACAB-BDF25660EEF3"),
        ComVisible(true),
        Codebase]
